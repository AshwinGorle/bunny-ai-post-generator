...
function SearchSection({onSearchInput}:any) {
  return (
    <div className='p-10 bg-black flex flex-col justify-center items-center text-white'>
        ...
        <h2 className='text-6xl font-bold bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 
            text-transparent bg-clip-text animate-gradient-slow shadow-lg relative overflow-hidden sparkle'>
